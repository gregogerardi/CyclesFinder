...
/**
 * Benchmark para decidir que algortimo conviene utilizar dadas las configuraciones de los grafos. Modificar los valores de numberOfNodes
 * numberOfEdges and limits to change the circuits configuration
 */
public class PerformanceJohnsonVsDFS {
    ...
    public static void main(String[] args) {
        ...
        int[] limits = {1, 2, 3, 5, 10, 15, 20, 30, 50, 100, 150, Integer.MAX_VALUE};
            ...
            for (int nNodes : numberOfNodes) {
                ...
                for (int nEdges : numberOfEdges) {
                    ...
                    for (int limit : limits) {
                        ...
                        pw.println(new StringBuilder().append("\t \t For ").append("max length: ").append(limit).append(" the best choice is ").append(mediaDfsTime > mediaJohnsonTime ? "DFS" : "Johnson").toString());
                    }
                }
            }
        } catch (IOException e) {
